...
[ApiController]
public class PublishersController(IPublishersService publishersService) : ControllerBase
{
    private readonly IPublishersService _publishersService = publishersService;
