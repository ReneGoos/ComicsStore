...
public class StoryBooksRepository(ComicsStoreDbContext context) : ComicsStoreCrossRepository<StoryBook, IStoryBook>(context), IComicsStoreCrossRepository<StoryBook, IStoryBook>
{
