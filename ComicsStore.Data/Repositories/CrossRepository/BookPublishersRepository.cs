...
public class BookPublishersRepository(ComicsStoreDbContext context) : ComicsStoreCrossRepository<BookPublisher, IBookPublisher>(context), IComicsStoreCrossRepository<BookPublisher, IBookPublisher>
{
