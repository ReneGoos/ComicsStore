...
public class StoryCharactersRepository(ComicsStoreDbContext context) : ComicsStoreCrossRepository<StoryCharacter, IStoryCharacter>(context), IComicsStoreCrossRepository<StoryCharacter, IStoryCharacter>
{
